...
\todo{Euh, c'est censé être pour quoi ça~? (Nathanaël)}
...
\todo{Selon moi, soit tu dis ``quelques 12 Mo'', soit ``$\sim$ 12
  Mo'', mais pas les deux... (Nathanaël)}
...
\todo{Selon moi, ça devrait être \lstbash{qmake && make} dans le premier cas, mais enlève cette note si c'est pas le cas... (Nathanaël)}
